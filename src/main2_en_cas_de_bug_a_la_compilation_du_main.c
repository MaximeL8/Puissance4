...
int **plateau=NULL,i,c,joueur=1,couleur,couleurbot,couleur2,r;
Pos **coor=NULL;
        ...
        while(SDL_PollEvent(&event))
        {
            switch(event.type)
            {
                ...
                case SDL_MOUSEBUTTONDOWN:
                    ...
                    {
                        tempTab = x;
                        if(event.motion.x < 316 && event.motion.x >= 221 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,0);}
                        if(event.motion.x < 411 && event.motion.x >= 316 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,1);}
                        if(event.motion.x < 506 && event.motion.x >= 411 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,2);}
                        if(event.motion.x < 601 && event.motion.x >= 506 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,3);}
                        if(event.motion.x < 696 && event.motion.x >= 601 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,4);}
                        if(event.motion.x < 791 && event.motion.x >= 696 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,5);}
                        if(event.motion.x < 886 && event.motion.x >= 791 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,6);}
                        if(event.motion.x < 981 && event.motion.x >= 886 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,7);}
                        if(event.motion.x < 1069 && event.motion.x >= 981 && event.motion.y < 646){jvsj1(plateau,couleur,couleur2,joueur,8);}
                ...
                case SDL_KEYDOWN:
                    ...
                    if (x==2)
                    {
                        ...
                        if(event.key.keysym.sym == SDLK_SPACE){
                            printf("Tas appuyé sur espace gros dans x = %d", x);
                            if(pileouface() == 1)
                            {
...
//Commande de compilation : gcc src/main_non_bug7.5.c -o bin/prog -I include -L lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_mixer
